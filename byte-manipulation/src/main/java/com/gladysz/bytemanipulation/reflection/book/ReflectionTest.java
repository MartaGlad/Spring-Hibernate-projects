package com.gladysz.bytemanipulation.reflection.book;
...
public class ReflectionTest {
    ...
    public static void main(String[] args) throws NoSuchMethodException,
        ...
        Constructor<Book> constructor = descriptor
                .getConstructor(new Class[]{String.class, String.class, int.class});
